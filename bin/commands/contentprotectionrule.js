...
class ContentProtectionRuleCommand {
  constructor() {
    this.flags = 'content-protection-rule';
    this.desc = 'Display contents of content protection rule.';
...
module.exports = new ContentProtectionRuleCommand();
