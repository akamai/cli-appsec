...
class EvalRuleActionCommand {
  constructor() {
    this.flags = 'eval-rule-action';
    this.desc = '(Beta) Display evaluation rule action in a policy.';
  ...
  run(options) {
    out.print({
      promise: new EvalRules(options).getEvalRuleAction(),
      args: options,
      success: (args, data) => {
...
module.exports = new EvalRuleActionCommand();
