...
class EvalPenaltyBox {
  ...
  getPenaltyBox() {
    return this._policyProvider.policyId().then(policyId => {
      return this._version.readResource(URIs.EVAL_PENALTY_BOX, [policyId]);
    });
  }
  ...
  enablePenaltyBox() {
    return this._policyProvider.policyId().then(policyId => {
      ...
      return this._version.updateResource(URIs.EVAL_PENALTY_BOX, [policyId], protection);
    });
  }
