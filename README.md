...
Commands:
  ...
  penalty-box               Display contents of penalty box in a security policy.
  enable-penalty-box        Enable penalty box in a security policy.
  disable-penalty-box       Disable penalty box in a security policy.
